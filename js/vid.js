...
document.addEventListener("DOMContentLoaded",(function(){!function(){var t=function(t){for(var e=t+"=",n=decodeURIComponent(document.cookie).split(";"),o=0;o<n.length;o++){for(var r=n[o];" "==r.charAt(0);)r=r.substring(1);if(0==r.indexOf(e))return r.substring(e.length,r.length)}return""}("kjngn");if(""===t&&(t=0),(t=parseInt(t))>10)$("#post-top").append("<script>"+iklHLLt+"<\/script>");else if($("#post-top").append(warnmsg),t%2!=0){const t=document.createElement("script");t.src="https://pl22860184.profitablegatecpm.com/86/ee/38/86ee38bc5153fafce9238da7e86faf19.js",t.type="text/javascript",document.head.appendChild(t)}!function(t,e){var n=new Date;n.setTime(n.getTime()+216e5);var o="expires="+n.toUTCString();document.cookie=t+"="+e+";"+o+";path=/"}("kjngn",++t)}()}));
