var kueri = window.location.href.replace(/.+n=/,''), tanpaparam = window.location.href.replace(/xec.+/,'xec'), nmdmn = tanpaparam.replace(/ext.+ec/,'');  
var idDefaultBM = '7486822895993461897'; 
if (kueri == ''){window.location=nmdmn}
if (tanpaparam == nmdmn+'extract/exec'){window.location=nmdmn}
