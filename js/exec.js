var kueri = window.location.href.replace(/.+n=/,''), tanpaparam = window.location.href.replace(/x.+/,'x');  
var idDefaultBM = '7486822895993461897'; 
if (kueri == '' && tanpaparam == 'https://useqr.link/extract/exec'){window.location='https://useqr.link'}   
