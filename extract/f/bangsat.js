const IdCode = window.location.href.replace(/ht.+de=/,"").replace("#","").replace(/\&fbclid.+/,"").replace(/\&m.+1/,"").replace(/\m.+1/,"").toUpperCase();  
...
function ngonsole(){              
	  $(document).ready(function(){                      				
		$('a[href^="https://"]').each(function(){  			
			var linkdownloads = $(this).attr("href").replace("streamtape.com","watchadsontape.com");             
